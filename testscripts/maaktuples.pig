...
define myscript `/git/naward12/testscripts/script2.pl` input (stdin using PigStreaming('\t')) output (stdout) ship('/git/naward12/testscripts/script2.pl', '/git/naward12/testscripts/script3.pl');
