...
a = LOAD 'hdfs://p-head03.alley.sara.nl/data/public/common-crawl/award/testset/1346864471290_4.arc.gz' USING org.commoncrawl.pig.ArcLoader() as (date, length, type: chararray, statuscode, ipaddress, url, html);
