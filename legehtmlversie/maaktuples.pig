...
a = LOAD 'hdfs://p-head03.alley.sara.nl//data/public/common-crawl/parse-output/segment/1346876860611/134694*.arc.gz' USING org.commoncrawl.pig.ArcLoader() AS (charset: chararray, length, type: chararray, statuscode, ipaddress, url: chararray, html);
